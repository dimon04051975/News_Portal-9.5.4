...
#         post_v = Post(
#             datetime_post=datetime.strptime(request.POST['datetime_post'], '%d %b %Y'),
#             author_name=request.POST['author_name'],
#             header=request.POST['header'],
#         )
#         post_v.save()
#         send_mail(
#             subject=f'{post_v.author_name}{post_v.datetime_post.strptime("%d %b %Y")}',
#             message=post_v.header,
#             from_email='dimon04051975@yandex.ru',
#             recipient_list=['dimon04051975@mail.ru']
#
#         )
#         return redirect('post_v:make_post')
